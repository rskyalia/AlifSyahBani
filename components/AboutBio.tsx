  ...
  return (
    <div className="text-white max-w-xl">
      ...
      <div className="space-y-6 text-white/80 leading-relaxed">
        <p>
          Hello, I’m Alif. I am a prospective undergraduate student based in
          Indonesia, aspiring to pursue a dual focus in Computer Engineering and
          Business Economics at Universitas Brawijaya (UB).
        </p>
